...
if ( ! function_exists( 'html2wp_setup' ) ) :
	...
	function html2wp_setup() {
		 ...
		 * to change 'html2wp' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'html2wp', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'html2wp_custom_background_args', array(
 ...
 */
function html2wp_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'html2wp_content_width', 640 );
}
add_action( 'after_setup_theme', 'html2wp_content_width', 0 );
...
function html2wp_scripts() {
	wp_enqueue_style( 'html2wp-style', get_stylesheet_uri() );
